...
3. Search for "Quiver Buddy" in the Plugin Hub.
4. Click "Install" to add the plugin to your RuneLite client.

## Usage
Simply equip any ammunition in your quiver, and the Quiver Buddy Plugin will automatically display the amount on your screen. No additional steps are required!

## Support and Feedback
We appreciate any feedback you may have to help us improve the Quiver Buddy Plugin. If you encounter any issues or have suggestions for new features, please reach out to us on the RuneLite Discord server or through the GitHub repository's issue tracker.
